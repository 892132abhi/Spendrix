...
import { FiBriefcase, FiTrendingUp, FiShield } from 'react-icons/fi';
      ...
      {user && (
        <nav className="w-full bg-[#030303]/40 backdrop-blur-xl border-b border-white/5 py-4 sticky top-0 z-50 shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
          <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
            ...
            <button
              onClick={() => navigate('/candidate-dashboard')} // route by user role as needed
              className="px-4.5 py-2.5 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white font-mono font-black uppercase text-[10px] tracking-widest rounded-xl transition-all duration-300 border-0 cursor-pointer"
            >
              Go to Dashboard
            </button>
          </div>
