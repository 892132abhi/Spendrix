...
const ProfileEdit = () => {
  ...
  if (loading) return <div className="p-20 text-center font-black animate-pulse text-slate-400">SYNCING DOSSIER...</div>;
    ...
    <div className="min-h-screen bg-slate-50 py-12 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-[3rem] border border-slate-200 shadow-2xl overflow-hidden">
        ...
        <header className="bg-slate-900 p-10 text-white">
          ...
          <p className="text-slate-400 text-sm font-bold uppercase tracking-widest mt-1">Professional Records Sync</p>
        </header>
