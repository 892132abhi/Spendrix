...
import { 
  FiArrowLeft, FiEdit3, FiUser, FiMail, FiPhone, FiLinkedin, 
  FiBriefcase, FiLayers, FiFileText, FiDownload, FiCheckCircle,
  FiAward, FiBookOpen, FiMessageSquare
} from 'react-icons/fi';
    ...
    <div className="min-h-screen bg-slate-50/50 pb-16 font-sans">
      <nav className="sticky top-0 z-40 bg-white/85 backdrop-blur-md border-b border-slate-200/60 py-4 mb-8">
        <div className="max-w-6xl mx-auto px-6 flex justify-between items-center">
          ...
          <h1 className="text-[10px] font-black uppercase tracking-[0.25em] text-slate-400">Interviewer Profile Management</h1>
          <button 
            ...
            onClick={() => navigate("/interviewer-editprofile")}
          >
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <section className="bg-white rounded-3xl border border-slate-200/60 p-8 shadow-sm">
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="text-[8px] font-black px-2.5 py-1 bg-emerald-50 text-emerald-700 border border-emerald-100 rounded uppercase tracking-wider">PDF DOCUMENT</span>
            </div>
            {profile?.resume ? (
              <div className="flex items-center p-6 bg-white rounded-[2rem] border border-dashed border-slate-900">
                <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-indigo-600 shadow-sm mr-6 shrink-0">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="flex items-center gap-2 px-6 py-3 bg-white text-indigo-600 font-bold text-xs uppercase rounded-2xl border border-indigo-100 shadow-sm hover:bg-indigo-600 hover:text-white transition-all cursor-pointer"
                >
