...
def send_otp_email_task(user_id, otp, minutes=1):
    ...
    message = f"Hi {user.username},\n\nYour OTP is: {otp}. Expires in {minutes} minutes."
...
# =========================
# AI JOB RECOMMENDATION TASK (SAFE VERSION)
# =========================
@shared_task(bind=True, max_retries=3)
def send_job_recommendations_email(self, profile_id):
    try:
        ...
        try:
            ...
            # retry Celery task instead of failing completely
...
# =========================
# SCHEDULED TASK (BEAT ENTRY POINT)
# =========================
@shared_task
